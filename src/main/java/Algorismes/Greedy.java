...
public class Greedy {
    ...
    public ArrayList <Node> greedyCamiMinim(Server serverInicial, Server serverBuscat, Node[] nodes, Node nodeInicial){
        ...
        while (!funcEx.serverTrobat(n, serverBuscat)){
            ...
            n = funcEx.whichCostIsFeaseble(n, solution);
            ...
            if (comptadorCuldeSac == n.getConnectsTo().size()){
                solution.clear();
                break;
            }
        }
