...
public class Backtracking {
     ...
     *
     *
     * @param servers: Aquesta variable conté els servidors amb els usuaris repartits
     * @param posicio
     * @param best
    ...
    public double backtringDistribucioCarrega(List<Server> servers, int posicio, double best, List <Server> possibleSolucio, List <Server> solution, User[] users) {
